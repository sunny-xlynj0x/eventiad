...
public class Main4 {
	...
	public static void main(String[] args) {
		...
		// STEP 1. MemberRegisterService 생성자의 @Autowired의 required 값을 false로 지정
		// STEP 2. MemberInfoPrinter의 memDao 필드의 @Autowired의 required 값을 false로 지정
		// STEP 3. MemberInfoPrinter 클래스의 setPrinter() 메서드에 추가한 @Qualifier("sysout") 코드 삭제
