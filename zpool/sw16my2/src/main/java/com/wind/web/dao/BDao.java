...
public class BDao {
	...
	public BDao() {
		...
		try {
			...
			dataSource = (DataSource) context.lookup("java:comp/env/jdbc/WorklightDS");
		} catch (Exception e) {
...
//			String query = "insert into mvc_board (bName, bTitle, bContent, bHit, bGroup, bStep, bIndent) values (?, ?, ?, 0, 0, 0, 0 )";
			String query = "INSERT INTO `mvc_board` (`BNAME`,`BTITLE`,`BCONTENT`,`BHIT`,`BGROUP`,`BSTEP`,`BINDENT`) VALUES (?, ?, ?, 0, LAST_INSERT_ID()+1, 0, 0)";
