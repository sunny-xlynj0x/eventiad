...
<%--
  ${vetspeslist[dto.id-1].specialty_id}
  ${vetspeslist[0].vet_id}
--%>

<%-- 
${specialtieslist[0].name}
${specialtieslist[1].name}
${specialtieslist[2].name}
${specialtieslist[3].name} 
--%>

<br>

<%--   <c:forEach items="${vetspeslist}" var="dto" varStatus="status">
    (${dto.vet_id }, ${dto.specialty_id }), 
  </c:forEach> --%>
